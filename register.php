...
<head>
  ...
  <title>
    APLIKAsi PROFILE MATCHING GENERiC
  </title>
              ...
              <div class="card-body">
                <div class="row">
                  <div class="col-md-5 mr-auto">
                    ...
                    <form class="form" method="post" action="aksi_registrasi.php">
                  ...
                  <div class="col-md-5 mr-auto">
                    ...
                    <div class="text-center">
                      <input type="submit" name="submit" class="btn btn-primary btn-round mt-4" value="Create">
