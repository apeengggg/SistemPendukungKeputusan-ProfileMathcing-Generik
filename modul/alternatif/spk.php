 ...
 ?>	
	...
	<!-- 									<a href="?module=spk&act=tambah">
								    ...
								    while ($r=mysqli_fetch_array($tampil)){
								    	// ?module=nilai&act=detail_nilai&id_spk=2&nama_spk=Rekomendasi%20Dosbing%20Skripsi
								       echo "<tr>
								       			<td>$no</td>
												<td><a href=?module=nilai&act=detail_nilai&id_spk=$r[id_spk]&nama_spk=$r[nama_spk]>$r[nama_spk]</a></td>
												<td>$r[keterangan]</td>
											</tr>";
								      $no++;
								    }
