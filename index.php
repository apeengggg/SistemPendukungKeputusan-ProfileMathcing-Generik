            ...
            <form class="form" method="post" action="cek_login.php">
              <div class="card card-login card-hidden">
                ...
                <div class="card-footer justify-content-center">
                  ...
                  <button type="button" class="btn btn-fill btn-info" onclick="window.location.href='register.php'">Sign Up</button>
                </div>
                <center><a href="lupa_password.php">Forget Password</a></center>
                <br><br>
